...
import time
import math
#Jogo programado por mim, Porém eu não criei nem detenho direitos sobre a criação "Snake", este jogo foi criado apenas por diversão em questão de uma hora... por favor, não entendam errado eu apenas criei este programa para fins de melhorar as minhas abilidades
